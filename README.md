...
During local development variables are directly loaded into *process.env* via Serverless. No *.env* file is created, so your local development and deployment tasks do not interfere :-) 
